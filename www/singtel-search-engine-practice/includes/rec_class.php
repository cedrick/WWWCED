						...
						while($row=mssql_fetch_array($result))
							{
								...
								echo "<td>".'<a id = "view_all"  target="_blank" href="data_view.php?id='.$row['PhoneNumber'].' ">View All Info</a>'."</td>";
								echo "<td>".'<a id = "view_history"  target="_blank" href="data.php?id='.$row['PhoneNumber'].'&campaign='.$row['Campaign'] .' ">View Call History</a>'."</td>";
