...
<div id="maintop"></div>
	<div id="right">
	  <form action="posinsertcode.php" method="post" enctype="multipart/form-data" id="form1">
          <div align="center">
            <p>&nbsp;</p>
 ...
 if( mysql_num_rows( mysql_query("SHOW TABLES LIKE '".$cust."'")))//firewall
{
	...
	if($cust!=null)//firewall2
	{
		 ...
		 $result= mysql_query( "select * from $cust where id='$cust' && tag='CHECKOUT' ") or die(mysql_error());		
	if ($result)//result
	{
                ...
                <td width="516" height="24"><div align="center">
                  <p class="style3">CASHIER</p>
                    <p>  
                      ...
                      <label></label>
                      <label>
                      <input type="text" name="txtpaym" id="txtpaym" />
                      <br />
                      </label>
                      <span class="style2"><strong>
                      <input type="submit" name="cmdok" id="cmdok" value="  PAYMENT   " />
                    </strong></span></p>
                </div></td>
              </tr>
            </table>
  ...
  <div id="rightcol">
	...
	<div id="left">
			...
			<ul>
			  ...
			  <p><img src="images/thmb_Sunrise.jpg" alt="" width="225" height="199" /><img src="images/thmb_Aerial.jpg" alt="" width="224" height="189" />
			    <input type="text" name="txtpaym" id="txtpaym" />
			  </p>
		    </ul>
