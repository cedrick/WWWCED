...
<div id="maintop"></div>
	<div id="right">
	  <form action="reserv.php" method="post" enctype="multipart/form-data" id="form1">
          <div align="center">
            <p>&nbsp;</p>
           ...
           <?php
            ...
            if($pay==$fif)
				...
				{
				  mysql_query("CREATE TABLE $id(id INT NOT NULL AUTO_INCREMENT,PRIMARY KEY(id),name VARCHAR(30),fname VARCHAR(30),mi VARCHAR(30),place VARCHAR(30),cont# INT(11),trip VARCHAR(30),customer qty INT(30),twentydisc INT(30),resdate DATE(),outdate DATE(),rooms VARCHAR(30),clerk VARCHAR(30))")or die(mysql_error());
				  
				  $result=mysql_query( "insert into $id values('$id','$name','$ln','$mi','$plc','$num') ") or die(mysql_error());
				...
				{
				  echo "Insufficient Downpayment";
				  echo '<a href="reserv.php">Try Again</a>';
