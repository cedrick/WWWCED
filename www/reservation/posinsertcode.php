...
<body>
			...
			fscanf(STDIN,"%d",$payment);
				
			 $customer=$_COOKIE['nid'];
			  mysql_connect("localhost","root")or die(mysql_error());
			  mysql_select_db("dbacc")or die(mysql_error());
			  
			  $result=mysql_query("select*from $customer where id='$customer'") or die(mysql_error());
			 ...
			 $checkin=$row['checkin'];
			  ...
			  $checkout=$row['checkout'];
				...
				$date=date("j");
			  if($payment>=$gt && is_numeric($payment))
			  
			  {
					...
					$sql="UPDATE $customer SET tag='CHECKOUT' WHERE tablename='$customer'";
	$result=mysql_query($sql);
	
					$sql="UPDATE $customer SET pay='$payment' WHERE tablename='$customer'";
	$result=mysql_query($sql);
	
$sql="UPDATE $customer SET sukli='$change' WHERE tablename='$customer'";
	$result=mysql_query($sql);
