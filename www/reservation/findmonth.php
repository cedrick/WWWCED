...
<div id="header"> 
  ...
  <div id="menu">
		<ul>
			...
			<li id="button2"><a href="reservation.php" title="">Confirm</a></li>
		  <li id="button3"><a href="cc.php" title="">Booking</a></li>
	    <li id="button4"><a href="viewreserved.php" title="">Rervation</a></li>
...
<div id="maintop"></div>
	<div id="right">
	  <form id="form1" method="post" action="serview.php">
	    <p>&nbsp;</p>
	    <p>&nbsp;</p>
	    <table width="257" border="0" align="center">
          <tr>
            <td width="157"><span class="style3">Search By: Month</span></td>
            <td width="111"><label>
	  ...
	  <h4><br />
			...
			<div class="read"><img src="images/LaluzLogoV4.gif" alt="" width="110" height="96" align="right" /></div>
