...
<div id="header"> 
	...
	<div id="menu">
		<ul>
		  ...
		  <li id="button3"><a href="vc.php" title="">Purchasing</a></li>
		  <li id="button4"><a href="stocks.php" title="">Stocks</a></li>
...
<div id="maintop"></div>
	<div id="right">
        <h4><img src="images/LaluzLogoV4.gif" alt="" width="110" height="96" align="right" /></h4>
        <p>&nbsp;</p>
        <p><img src="images/Umbrellas_7.JPG" alt="" width="580" height="300" /><br />
        </p>
			    <div class="read"></div>
