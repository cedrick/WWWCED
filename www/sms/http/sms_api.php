...
class sms {
    ...
    var $api_id = "YOUR_mysmsaddress.com_API_NUMBER";

    /**
    * mysmsaddress.com username
    * @var mixed
    */
    var $user = "USERNAME";

    /**
    * mysmsaddress.com password
    * @var mixed
    */
    ...
    * @access public
    */
    function sms ($user,$pass) {
        if ($this->use_ssl) {
            $this->base   = "http://www.mysmsaddress.net/smsc/general";
            $this->base_s = "https://www.mysmsaddress.net/smsc/general";
        } else {
            $this->base   = "http://www.mysmsaddress.net/smsc/general";
    ...
    */
    function _auth() {
    //	$comm = sprintf ("%s/sendsms.jsp?api_id=%s&user=%s&password=%s", $this->base_s, $this->api_id, $this->user, $this->password);
    ...
    */
    function getbalance() {
    	$comm = sprintf ("%s/getbalance.jsp?user=%s&password=%s", $this->base, $this->user, $this->password);
...
*/
    	...
    	/* Send SMS now */
    	$comm = sprintf ("%s/sendmsg.jsp?user=%s&password=%s&session_id=%s&to=%s&from=%s&text=%s&callback=%s&unicode=%s%s",
	    $this->base,
	    $this->user,
	    $this->password,
            $this->session,
