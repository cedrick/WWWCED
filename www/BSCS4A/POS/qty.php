     	...
     	<center>
	     	<?php
				...
				$check = new Check();
					...
					echo "<font size=5 color=blue>SELECTED ITEMS</font>";
					$check->show_basket($item,$qty);
					
					if(isset($_POST['QTY']))
					{
							$check->insert_basket($item,$qty,$product,$code,$category,$price,$total);
						
					}
					echo "<br><br>";
					echo '<input type="text" name="qty" id="qty" />';
		     		echo '<input type="submit" name="QTY" id="QTY" value="ADD to Basket" />';
					echo "<br><br>";
					echo "<font size=5 color=blue>BASKET</font>";
