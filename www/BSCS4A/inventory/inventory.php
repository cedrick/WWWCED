...
<form id="form1" name="form1" method="post" action="search_admin.php">
  <div id="mother">
    ...
    <p>&nbsp;</p>
  <div id="header">
<table width="564" height="75" border="0" align="right">
<tr>
          <td width="120" height="71"><div align="left"><a href="inventory_home.php">
...
<p>
<div style="width: 850px; height:550px; overflow:auto;  padding-left:90px; scrollbar-highlight-color :#F0DEE5; scrollbar-face-color : #D4AEBB; "><?php
