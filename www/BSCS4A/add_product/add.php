...
<form id="form1" name="form1" method="post" action="add_code.php">
  ...
  <div id="mother">
    ...
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p align="center" class="style14">Add New Item </p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <table width="308" height="244" border="0" align="center">
      ...
      <tr>
        <td height="41" colspan="2"><div align="right">
            <input type="submit" name="btnad" id="btnad" value="Add Item  " />
        </div></td>
      </tr>
    </table>
  </div>
