  ...
  <div id="mother">
    ...
    <div id="header">
      <table width="564" height="67" border="0" align="right">
        <tr>
          <td width="120" height="63"><div align="left"><a href="../inventory/inventory_home.php">
              <input type="image" name="imageField2" id="imageField2" src="../css/homeicon.JPG" />
              <a href="inventory_home.php">HOME</a></div></td>
   			 <td width="193"><div align="left"><a href="../inventory/inventory.php"><a href="inventory.php">
    ...
    <table align="right">
    	...
    	<tr>
    		...
    		<td></td>
    		<td>
    			<a target="_blank" href="daily_sales.php"><font size="3" color="GRAY">Daily</font></a>
    		</td>
    		<td></td>
    		<td></td>
    		<td>
    			<a target="_blank" href="ym_sales.php"><font size="3" color="GRAY">Weekly/Monthly/Yearly</font></a>
    		</td>
    	</tr>
    </table>
