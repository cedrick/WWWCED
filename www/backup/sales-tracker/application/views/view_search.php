...
<table width=800 border=0 align=center cellspacing=1 bgcolor= #EAE8E7>
	<tr>
		<td>
			Agent ID:
		</td>
	...
	<tr>
		...
		<td>
			<?php echo form_dropdown('campaign',$campaign,$action_campaign); ?>
		</td>
...
<table width=800 border=0 align=center cellspacing=1 bgcolor= #EAE8E7>
	...
	<td>
		...
		<b>
			<?php echo '<td align="center"><a href="'.base_url().'user/call_phone/">Return<a></td>'; ?>
		</b>
	</tr>
</table>
